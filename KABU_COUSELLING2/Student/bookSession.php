...
<div class="split right">
  ...
  <label><b>Registration Number:</b></label><br>
		...
		<input type="time" placeholder="Set time" name="time" id="p2" required><input type="email"name="email"placeholder="Enter email"><br>
...
if(isset($_POST['submit'])){
  $db= mysqli_connect("localhost","root","","kabarak_db");
    ...
    $email=$_POST['email'];
		...
		$sql = "INSERT INTO booking (fname, gender, contact,regnumber,dates,tim,email,texts) VALUES ('$sname','$gender','$contact','$regnumber','$dates','$times','$email','$texts') ";
